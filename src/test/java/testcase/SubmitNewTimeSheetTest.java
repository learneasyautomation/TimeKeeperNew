...
public class SubmitNewTimeSheetTest extends ExtentReportClass {
    ...
    @Test(enabled = true, priority = 1, groups = {"smoke", "regression"}, description = "Employee submits timesheet for weekday without uploading attachment")
