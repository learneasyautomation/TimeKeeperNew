        ...
        try {
            ...
            if (driver.getTitle().contains("Time Keeper")) {
                ...
                if (objHome.getTextMyTimeMenu().equalsIgnoreCase("My Time")) {
                    ...
                    objHome.enterTimeForWeekEnd(DataProviderFactory.getExcel().getData(0,4,1));
                    objHome.enterComments();
                    objHome.addTask();
                    objHome.selectAdditionalTask();
                    objHome.enterTimeForWeekDaysForAdditionalTask(DataProviderFactory.getExcel().getData(0,5,1));
                    objHome.enterTimeForWeekEndForAdditionalTask(DataProviderFactory.getExcel().getData(0,6,1));
